...
class AccountServiceTest {
    ...
    void addAndGetUser() {
        ...
        assertEquals(2, this.accountService.findAllAccounts().size(),
    ...
    void bindAccountActivity() {
        try {
            ...
            this.accountService.saveAccount(this.testAccount1);
            this.accountService.saveAccount(this.testAccount2);
            this.accountService.saveAccount(this.testAccount3);
            this.activityRepository.save(this.testActivity1);
